...
class PayController extends Controller{
	  ...
	  public function wxpayOrderAction(){
    	...
    	$orderinfo=$order->getDetaiByOrderNum($orderNo);
	...
	$stringA ="appId=".$appId."&package=".$pack."&nonceStr=".$nonceStr."&timeStamp=".$timeStamp;
	echo $stringA."</br>";
	$stringSignTemp=$stringA."&key=1e00dc3a9cf1f5755a8f341bf17882c2";
	...
	echo $sign."</br>";
		...
		$orderList = "http://m.12307.com/index.php?p=home&c=my";
	return;
		$basePath = BASE_PATH;
